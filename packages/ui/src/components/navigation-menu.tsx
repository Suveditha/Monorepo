  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          'origin-top-center bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-md border border-[#e4e4e7] shadow md:w-(--radix-navigation-menu-viewport-width)',
          className
        )}
        {...props}
      />
