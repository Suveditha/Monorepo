...
export function BentoAnalyticsCard({
  ...
  return (
    ...
    >
      <CardHeader>
        <CardTitle className="text-xl font-semibold">Export It Instantly</CardTitle>
      </CardHeader>
      <CardContent className="overflow-hidden p-0 pb-6">
        <p className="mb-6 line-clamp-2 px-6 text-sm text-muted-foreground">
          Download finished videos immediately, optimized for sharing on social media or presentations.
        </p>
