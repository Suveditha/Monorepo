...
export function BentoPipelinesCard({
  ...
  return (
    ...
    >
      <CardHeader>
        <CardTitle className="text-xl font-semibold">Choose From 100s Of Voices</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <p className="line-clamp-2 text-sm text-muted-foreground lg:max-w-[55%]">
          Pick realistic AI voices in multiple languages and accents for every project.
        </p>
