          ...
          <div className="container relative space-y-10">
            <div>
              <h2 className="mb-2.5 text-3xl font-semibold md:text-5xl">
                AI-Powered Video Voice Features
              </h2>
              <p className="mt-1 max-w-2xl text-muted-foreground md:mt-6">
                {APP_NAME} lets you create engaging videos faster. Edit recordings, select AI or custom voices, and export high-quality, professional voiceover videos for tutorials, demos, or business presentations.
              </p>
            </div>
