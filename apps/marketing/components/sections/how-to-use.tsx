            ...
            <div className='container bg-diagonal-lines'>
                <div className="relative grid gap-10 items-center sm:container bg-background py-20 lg:grid-cols-2 lg:border-x">
                    ...
                    <div className="order-1 lg:order-2">
                        <div className="mt-6 list-none flex-wrap items-center gap-10 space-y-3 md:flex md:space-y-0">
                            {[
                                { 
                                    number: 1, steps: "Just add any screen recording video...",
                                    image: "assets/sample/Blue-Step-1.png", 
                                ...
                                { 
                                    ...
                                    image: "assets/sample/Blue-Step-5.png",
                    ...
                    <div className="order-2 md:order-1 self-start md:sticky md:top-24">
                        <Image className='rounded-2xl' src="/assets/sample/Blue-Step-1.png" width={1240} height={840} alt="How to use"></Image>
                    </div>
                </div>
            </div>
        </GridSection>
