    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="animate-fade-in">
            <Badge variant="secondary" className="mb-8 text-videomule-green bg-videomule-green/10 border-videomule-green/20 animate-scale-in">
            ...
            <h1 className="font-bricolage text-5xl lg:text-7xl font-bold text-videomule-black mb-6 leading-tight animate-fade-in delay-200">
              Add voice to any<br />Screen Recording.
            </h1>
            <p className="text-xl text-videomule-gray mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in delay-300">
              Turn silent recordings into engaging videos with AI voiceovers. Generate scripts, choose from 100+ voices, and export instantly.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in delay-500">
              <Button size="lg" className="text-lg px-8 py-4 hover-scale transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                Start for Free
