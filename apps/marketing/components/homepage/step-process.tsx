...
import { Play, Upload, FileText, Mic, Download,Check, Edit, Video } from "lucide-react";
    ...
    const step = [
        {
            ...
            description: "Simply drag and drop your screen recording into VideoMule. We support all major video formats and process them instantly in the cloud.",
            point : ["Supports MP4, MOV, AVI, WMV formats", "Instant cloud processing", "Secure file handling"],
            ...
            htmlCode: (
                <div className="p-8">
                    <div className="border-2 border-dashed border-blue-300 rounded-xl p-12 text-center bg-blue-50 hover:bg-blue-100 transition-colors cursor-pointer">
                      ...
                      <h4 className="font-semibold text-videomule-black mb-2">Drop your video here</h4>
                      <p className="text-videomule-gray text-sm mb-4">or click to browse files</p>
                      <Button variant="outline" size="sm">Select File</Button>
                    </div>
                    
                    {/* Recent Uploads */}
                    <div className="mt-6">
                      <h5 className="font-semibold text-videomule-black mb-3">Recent uploads</h5>
                      <div className="space-y-2">
                        {['tutorial-demo.mp4', 'product-walkthrough.mov'].map((name, i) => <div key={i} className="flex items-center p-2 bg-gray-50 rounded-lg">
                            <Video className="w-4 h-4 text-blue-500 mr-3" />
                            <span className="text-sm text-videomule-black flex-1">{name}</span>
                            <span className="text-xs text-videomule-gray">2 min ago</span>
                          </div>)}
                      </div>
                    </div>
                </div>
        ...
        },
        {
            ...
            logo: FileText,
            color: 'bg-purple-500',
            heading: "AI Generates Script",
            description: "Our advanced AI analyzes your video content and creates a natural, professional script that matches your recording perfectly.",
            point : ["Smart content analysis", "Natural language generation", "Fully editable output"],
            browserheading: "videomule.com/script",
            htmlCode: (
                <div className="p-8">
                    <div className="flex items-center justify-between mb-4">
                    <h4 className="font-semibold text-videomule-black">Generated Script</h4>
                    ...
                    <div className="prose prose-sm max-w-none">
                        ...
                        projects. As you can see, the interface is clean and intuitive...
        ...
        },
        {
            ...
            htmlCode: (
                <div className="p-8">
                    <h4 className="font-semibold text-videomule-black mb-6">Voice Library</h4>
                    <div className="space-y-3 mb-6">
                        ...
                        accent: "Australian",
                        active: false
                        }].map((voice, i) => <div key={i} className={`flex items-center justify-between p-4 rounded-xl border-2 cursor-pointer transition-all ${voice.active ? 'bg-orange-50 border-orange-300' : 'bg-gray-50 border-gray-200 hover:border-orange-200'}`}>
                            <div className="flex items-center">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold mr-4 ${voice.active ? 'bg-orange-500' : 'bg-gray-400'}`}>
                                {voice.name[0]}
                                </div>
                                <div>
                                <h5 className="font-semibold text-videomule-black">{voice.name}</h5>
                                <p className="text-sm text-videomule-gray">{voice.type} • {voice.accent}</p>
                                </div>
                            </div>
                            <Play className={`w-5 h-5 ${voice.active ? 'text-orange-500' : 'text-gray-400'}`} />
                            </div>)}
                    </div>
                    ...
                    <div className="bg-orange-50 rounded-xl p-4">
                        <div className="flex items-center justify-between mb-3">
                            <span className="text-sm font-semibold text-videomule-black">Preview: Sarah</span>
                        ...
                        <div className="flex items-center space-x-1">
                            {Array.from({
                                length: 24
                                    ...
                                    <div 
                                        key={i} className="bg-orange-400 rounded-sm" 
                                        style={{
                                            width: '2px',
        ...
        },
        {
            ...
            heading: "AI Generates Script",
            description: "Our advanced AI analyzes your video content and creates a natural, professional script that matches your recording perfectly.",
            point : ["Perfect AI synchronization", "HD quality export", "Multiple format options"],
            browserheading: "videomule.com/export",
            htmlCode: (
                <div className="p-8">
                    <h4 className="font-semibold text-videomule-black mb-6">Ready to Export</h4>
                    {/* Video Preview */}
        ...
        <section className="py-24 bg-white relative" id="how-it-works">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-20 animate-fade-in">
                    <Badge variant="secondary" className="mb-6 text-videomule-green bg-videomule-green/10 border-videomule-green/20 animate-scale-in">
                    ...
                    Turn your silent screen recordings into engaging videos with professional AI voiceovers in minutes
                    </p>
                </div>
